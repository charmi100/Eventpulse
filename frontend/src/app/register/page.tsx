    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .ce-location-hint { background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.07); border-radius: 10px; padding: 12px 16px; font-size: 13px; }
        .ce-btn { width: 100%; padding: 15px; background: linear-gradient(135deg, #e94560, #c0203d); color: #fff; border: none; border-radius: 10px; font-size: 12px; font-weight: 700; cursor: pointer; }
      `}</style>
        ...
        <div className="ce-body">
          <div className="ce-form-side">
            ...
            <form onSubmit={handleSubmit}>
              <input className="ce-input" placeholder="Event Name" value={form.name} onChange={e => setForm({ ...form, name: e.target.value })} />
              ...
              <input type="date" className="ce-input" value={form.date} onChange={e => setForm({ ...form, date: e.target.value })} />

              <input type="time" className="ce-input" value={form.time} onChange={e => setForm({ ...form, time: e.target.value })} />
